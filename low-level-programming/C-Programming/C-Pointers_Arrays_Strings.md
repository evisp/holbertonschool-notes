...
- Pointers are declared as: var`_`type *var; Variable var is a pointer (*) that points to a var`_`type. The value of var is a memory address holding a value of type var`_`type
